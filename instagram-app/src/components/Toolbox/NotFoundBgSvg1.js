...
const NotFoundBgSvg1 = ({color, className}) => {
   return (
         <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="horse"
              className="svg-inline--fa fa-horse fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512">
