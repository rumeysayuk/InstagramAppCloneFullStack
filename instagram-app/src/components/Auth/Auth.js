            ...
            <Paper className={classes.paper} elevation={6}>
               ...
               <form className={classes.form} onSubmit={handleSubmit}>
                  <Grid container spacing={2}>
                     {isSignUp && (
                        <>
                           <CustomInput name={"firstName"} label={"İsminiz"} handleChange={handleChange}
                                        autoFocus half/>
                           <CustomInput name={"lastName"} label={"Soyisminiz"} handleChange={handleChange} half/>
                           <CustomInput name={"username"} label={"KUllanıcı adınız"} handleChange={handleChange}/>
                        </>
                     )}
                     ...
                     {isSignUp && (
                        <CustomInput name={"confirmPassword"} label={"Şifre tekrarı"} handleChange={handleChange}
                                     type={"password"}/>
                     )}
                  </Grid>
